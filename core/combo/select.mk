...
$(combo_target)RELEASE_CFLAGS := -O3 -fno-tree-vectorize -fno-inline-functions -fno-unswitch-loops -fgcse-after-reload -fipa-cp-clone -fpredictive-commoning -fsched-spec-load -fvect-cost-model -g -Wstrict-aliasing=3 -Werror=strict-aliasing
